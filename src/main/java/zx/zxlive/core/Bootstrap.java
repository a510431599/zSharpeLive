...
import zx.zxlive.core.classloader.ClassLoaderBuilder;
...
public class Bootstrap {
    ...
    public static void main(String[] args) throws Exception {
        try {
            ...
            bootStrap();
            System.out.println("zx.zxlive.core.server.Bootstrap complete");
        } catch (Throwable t) {
            System.out.printf("zx.zxlive.core.server.Bootstrap exception: %s%n", t.getMessage());
            t.printStackTrace();
        } finally {
            System.out.println("zx.zxlive.core.server.Bootstrap exit");
        }
    }
    ...
    private static void bootStrap() throws InstantiationException, IllegalAccessException, ClassNotFoundException, NoSuchMethodException, InvocationTargetException {
        ...
        Object boot = Class.forName("zx.zxlive.Launcher", true, loader).getDeclaredConstructor().newInstance();
