...
public class VideoCodecFactory {
    ...
    public static IVideoStreamCodec getVideoCodec(IoBuffer data) {
        ...
        try {
            switch (codecId) {
                case 2: // sorenson 
                    result = (IVideoStreamCodec) Class.forName("zx.zxlive.common.codec.SorensonVideo").getDeclaredConstructor().newInstance();
                    break;
                case 3: // screen video
                    result = (IVideoStreamCodec) Class.forName("zx.zxlive.common.codec.ScreenVideo").getDeclaredConstructor().newInstance();
                    break;
                case 6: // screen video 2
                    result = (IVideoStreamCodec) Class.forName("zx.zxlive.common.codec.ScreenVideo2").getDeclaredConstructor().newInstance();
                    break;
                case 7: // avc/h.264 video
                    result = (IVideoStreamCodec) Class.forName("zx.zxlive.common.codec.AVCVideo").getDeclaredConstructor().newInstance();
                    break;
                case 8: // vp8
                    result = (IVideoStreamCodec) Class.forName("zx.zxlive.common.codec.VP8Video").getDeclaredConstructor().newInstance();
                    break;
                case 9: // vp9
                    result = (IVideoStreamCodec) Class.forName("zx.zxlive.common.codec.VP9Video").getDeclaredConstructor().newInstance();
                    break;
                case 10: // av1
                    result = (IVideoStreamCodec) Class.forName("zx.zxlive.common.codec.AV1Video").getDeclaredConstructor().newInstance();
                    break;
                case 11: // mpeg1video
                    result = (IVideoStreamCodec) Class.forName("zx.zxlive.common.codec.MPEG1Video").getDeclaredConstructor().newInstance();
                    break;
                case 12: // hevc
                    result = (IVideoStreamCodec) Class.forName("zx.zxlive.common.codec.HEVCVideo").getDeclaredConstructor().newInstance();
                    break;
            }
        } catch (Exception ex) {
