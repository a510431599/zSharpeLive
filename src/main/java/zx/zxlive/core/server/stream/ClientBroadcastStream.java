...
import zx.zxlive.core.server.api.event.IEventDispatcher;
import zx.zxlive.core.server.api.event.IEventListener;
import zx.zxlive.core.server.api.scope.IScope;
import zx.zxlive.core.server.api.statistics.IClientBroadcastStreamStatistics;
...
import zx.zxlive.core.server.jmx.mxbeans.ClientBroadcastStreamBean;
...
@Scope("prototype")
@Lazy
public class ClientBroadcastStream extends AbstractClientStream implements IClientBroadcastStream, IFilter, IPushableConsumer, IPipeConnectionListener, IEventDispatcher, IClientBroadcastStreamStatistics, ClientBroadcastStreamBean {
     ...
     */
    @Value("${broadcaststream.auto.record}")
    ...
    protected void registerJMX() {
        if (registerJMX) {
            ...
            try {
                ...
                mbs.registerMBean(new StandardMBean(this, ClientBroadcastStreamBean.class, true), oName);
