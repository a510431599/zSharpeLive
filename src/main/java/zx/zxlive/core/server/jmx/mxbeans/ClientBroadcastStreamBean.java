...
import zx.zxlive.core.server.api.stream.ResourceExistException;
import zx.zxlive.core.server.api.stream.ResourceNotFoundException;
 ...
 */
//@MXBean
public interface ClientBroadcastStreamBean {
