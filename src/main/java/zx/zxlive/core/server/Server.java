...
import zx.zxlive.core.server.api.listeners.IConnectionListener;
import zx.zxlive.core.server.api.listeners.IScopeListener;
...
public class Server implements IServer, ApplicationContextAware, InitializingBean, DisposableBean {
     ...
     */
    protected ConcurrentMap<String, IGlobalScope> globals = new ConcurrentHashMap<>(1, 0.9f, 1);

    /**
     * Mappings
     */
    protected ConcurrentMap<String, String> mapping = new ConcurrentHashMap<>(32, 0.9f, 8);
