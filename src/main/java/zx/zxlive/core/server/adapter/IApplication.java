 ...
 * This interface defines the methods that are called by Red5 through an applications life.
 * It is suggested that you NOT implement this interface yourself,
...
public interface IApplication {
     ...
     * 
     * @param app
     *            Application or room level scope. See {@link IScope} for details
     * @return <pre>
     * true
     * </pre>
     * 
     ...
     * 
     * @param conn
     *            Connection object used to provide basic connection methods. See {@link IConnection}
     * @param params
