...
package zx.zxlive.core.server.adapter;
...
import zx.zxlive.core.server.messaging.AbstractPipe;
import zx.zxlive.core.server.messaging.IMessageInput;
import zx.zxlive.core.server.scheduling.JDKSchedulingService;
...
import zx.zxlive.core.server.api.plugin.IRed5Plugin;
import zx.zxlive.core.server.api.plugin.IRed5PluginHandler;
import zx.zxlive.core.server.api.scheduling.IScheduledJob;
import zx.zxlive.core.server.api.scheduling.ISchedulingService;
import zx.zxlive.core.server.api.scope.IBroadcastScope;
import zx.zxlive.core.server.api.scope.IScope;
import zx.zxlive.core.server.api.service.IBroadcastStreamService;
import zx.zxlive.core.server.api.service.IOnDemandStreamService;
import zx.zxlive.core.server.api.service.IStreamSecurityService;
import zx.zxlive.core.server.api.service.IStreamableFileService;
import zx.zxlive.core.server.api.service.ISubscriberStreamService;
import zx.zxlive.core.server.api.service.ServiceUtils;
...
import zx.zxlive.core.server.api.stream.IOnDemandStream;
import zx.zxlive.core.server.api.stream.IPlayItem;
import zx.zxlive.core.server.api.stream.IStreamAwareScopeHandler;
import zx.zxlive.core.server.api.stream.IStreamPlaybackSecurity;
import zx.zxlive.core.server.api.stream.IStreamPublishSecurity;
import zx.zxlive.core.server.api.stream.IStreamService;
import zx.zxlive.core.server.api.stream.IStreamableFileFactory;
import zx.zxlive.core.server.api.stream.ISubscriberStream;
import zx.zxlive.core.server.jmx.mxbeans.ApplicationBean;
import zx.zxlive.core.server.plugin.PluginDescriptor;
import zx.zxlive.core.server.plugin.PluginRegistry;
import zx.zxlive.core.server.plugin.Red5Plugin;
import zx.zxlive.core.server.so.SharedObjectService;
import zx.zxlive.core.server.stream.IProviderService;
import zx.zxlive.core.server.stream.PlaylistSubscriberStream;
 ...
 */
@Component
public class MultiThreadedApplicationAdapter extends StatefulScopeWrappingAdapter implements ISharedObjectService, IBroadcastStreamService, IOnDemandStreamService, ISubscriberStreamService, ISchedulingService, IStreamSecurityService, ISharedObjectSecurityService, IStreamAwareScopeHandler, ApplicationBean {
    ...
    private IProviderService getProviderService() {
        if (providerService == null) {
            try {
                providerService = (IProviderService) ScopeUtils.getScopeService(scope, IProviderService.class, Class.forName("zx.zxlive.common.server.stream.ProviderService"));
