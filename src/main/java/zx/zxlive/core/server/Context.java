...
import zx.zxlive.core.server.api.scope.IScopeResolver;
import zx.zxlive.core.server.jmx.mxbeans.ContextBean;
...
import zx.zxlive.core.server.scope.Scope;
import zx.zxlive.core.server.api.service.IServiceInvoker;
import zx.zxlive.core.server.exception.ScopeHandlerNotFoundException;
...
public class Context implements IContext, ApplicationContextAware, ContextBean {
     ...
     */
    @Autowired
    @Qualifier("global.clientRegistry")
     ...
     */
    @Autowired
    @Qualifier("global.serviceInvoker")
     ...
     */
    @Autowired
    @Qualifier("global.mappingStrategy")
