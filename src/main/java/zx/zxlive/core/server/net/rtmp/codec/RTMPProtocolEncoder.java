...
public class RTMPProtocolEncoder implements Constants, IEventEncoder {
    ...
    private void doEncodeSharedObject(ISharedObjectMessage so, IoBuffer out) {
        ...
        final Output output = new zx.zxlive.common.io.amf.Output(out);
        final Output amf3output = new zx.zxlive.common.io.amf3.Output(out);
    ...
    protected void encodeCommand(IoBuffer out, ICommand command) {
        // TODO: tidy up here
        Output output = new zx.zxlive.common.io.amf.Output(out);
        ...
        if (call.getServiceName() == null && "connect".equals(call.getServiceMethodName())) {
            ...
            output = new zx.zxlive.common.io.amf.Output(out);
        } else {
            if (Red5.getConnectionLocal().getEncoding() == IConnection.Encoding.AMF3) {
                output = new zx.zxlive.common.io.amf3.Output(out);
            } else {
                output = new zx.zxlive.common.io.amf.Output(out);
            }
        }
