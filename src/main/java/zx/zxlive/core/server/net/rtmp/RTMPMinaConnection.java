...
import zx.zxlive.core.server.jmx.mxbeans.RTMPMinaConnectionBean;
...
@Component
@Scope("prototype")
public class RTMPMinaConnection extends RTMPConnection implements RTMPMinaConnectionBean {
    ...
    protected void registerJMX() {
        ...
        try {
            ...
            oName = new ObjectName(String.format("zx.zxlive.common.server:type=%s,connectionType=%s,host=%s,port=%d,clientId=%s", cName, type, hostStr, port, client.getId()));
            if (!mbs.isRegistered(oName)) {
                mbs.registerMBean(new StandardMBean(this, RTMPMinaConnectionBean.class, true), oName);
            } else {
