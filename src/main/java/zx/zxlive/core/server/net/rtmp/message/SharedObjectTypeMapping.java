...
package zx.zxlive.core.server.net.rtmp.message;
...
public class SharedObjectTypeMapping {
     ...
     * Types map
     */
    public static final ISharedObjectEvent.Type[] typeMap = new ISharedObjectEvent.Type[] { null, ISharedObjectEvent.Type.SERVER_CONNECT, // 01
            ISharedObjectEvent.Type.SERVER_DISCONNECT, // 02
            ISharedObjectEvent.Type.SERVER_SET_ATTRIBUTE, // 03
            ISharedObjectEvent.Type.CLIENT_UPDATE_DATA, // 04
            ISharedObjectEvent.Type.CLIENT_UPDATE_ATTRIBUTE, // 05
            ISharedObjectEvent.Type.SERVER_SEND_MESSAGE, // 06
            ISharedObjectEvent.Type.CLIENT_STATUS, // 07
            ISharedObjectEvent.Type.CLIENT_CLEAR_DATA, // 08
            ISharedObjectEvent.Type.CLIENT_DELETE_DATA, // 09
            ISharedObjectEvent.Type.SERVER_DELETE_ATTRIBUTE, // 0A
            ISharedObjectEvent.Type.CLIENT_INITIAL_DATA, // 0B
    };
