...
import zx.zxlive.common.io.amf3.Input.RefStorage;
...
public class RemotingProtocolDecoder {
    ...
    protected List<RemotingCall> decodeCalls(IoBuffer in) {
        ...
        zx.zxlive.common.io.amf.Input input = new zx.zxlive.common.io.amf.Input(in);
        int count = in.getUnsignedShort();
        ...
        for (int i = 0; i < count; i++) {
            ...
            if (type == AMF.TYPE_ARRAY) {
                ...
                for (int j = 0; j < elements; j++) {
                    ...
                    if (isAMF3) {
                        refStorage = ((zx.zxlive.common.io.amf3.Input) input).getRefStorage();
                    }
                }
