...
import zx.zxlive.core.server.jmx.mxbeans.ContextLoaderBean;
...
public class ContextLoader implements ApplicationContextAware, InitializingBean, DisposableBean, ContextLoaderBean {
    ...
    protected void registerJMX() {
        ...
        try {
            oName = new ObjectName("zx.zxlive.common.server:name=contextLoader,type=ContextLoader");
            // check for existing registration before registering
            if (!mbs.isRegistered(oName)) {
                mbs.registerMBean(new StandardMBean(this, ContextLoaderBean.class, true), oName);
            } else {
