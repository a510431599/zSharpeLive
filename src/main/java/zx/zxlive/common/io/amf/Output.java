...
package zx.zxlive.common.io.amf;
...
import zx.zxlive.common.annotations.Anonymous;
import zx.zxlive.common.io.amf3.ByteArray;
import zx.zxlive.common.io.object.BaseOutput;
import zx.zxlive.common.io.object.ICustomSerializable;
import zx.zxlive.common.io.object.RecordSet;
import zx.zxlive.common.io.object.Serializer;
import zx.zxlive.common.io.utils.XMLUtils;
 ...
 */
public class Output extends BaseOutput implements zx.zxlive.common.io.object.Output {
    ...
    private static CacheManager constructDefault() {
        ...
        manager.addCacheIfAbsent("zx.zxlive.common.io.amf.Output.stringCache");
        manager.addCacheIfAbsent("zx.zxlive.common.io.amf.Output.getterCache");
        manager.addCacheIfAbsent("zx.zxlive.common.io.amf.Output.fieldCache");
        manager.addCacheIfAbsent("zx.zxlive.common.io.amf.Output.serializeCache");
        return manager;
    }
    ...
    protected static Cache getStringCache() {
        if (stringCache == null) {
            stringCache = getCacheManager().getCache("zx.zxlive.common.io.amf.Output.stringCache");
        }
        return stringCache;
    }
    ...
    protected static Cache getSerializeCache() {
        if (serializeCache == null) {
            serializeCache = getCacheManager().getCache("zx.zxlive.common.io.amf.Output.serializeCache");
        }
    ...
    protected static Cache getFieldCache() {
        if (fieldCache == null) {
            fieldCache = getCacheManager().getCache("zx.zxlive.common.io.amf.Output.fieldCache");
        }
        return fieldCache;
    }
    ...
    protected static Cache getGetterCache() {
        if (getterCache == null) {
            getterCache = getCacheManager().getCache("zx.zxlive.common.io.amf.Output.getterCache");
        }
        return getterCache;
    }
