...
public class HexCharset extends Charset {
    ...
    private class Encoder extends CharsetEncoder {
         ...
         */
        @Override
        public CoderResult encodeLoop(java.nio.CharBuffer in, java.nio.ByteBuffer out) {
    ...
    private class Decoder extends CharsetDecoder {
         ...
         */
        @Override
        public CoderResult decodeLoop(java.nio.ByteBuffer in, java.nio.CharBuffer out) {
            while (in.remaining() > 0) {
