...
package zx.zxlive.common.io.object;
...
import zx.zxlive.common.annotations.DontSerialize;
import zx.zxlive.common.annotations.RemoteClass;
    ...
    public static void serialize(Output out, Field field, Method getter, Object object, Object value) {
        ...
        if (value instanceof IExternalizable) {
            ...
            if (nans > 0) {
                ...
                ((zx.zxlive.common.io.amf3.Output) out).enforceAMF3();
